...
function PartnerTransferMultipleLeadModalPopup(props) {
	...
	const handleTransferLead = () => {
		axios
			.put(`sales/leads/doctor-leads/transfer`, {
...
PartnerTransferMultipleLeadModalPopup.propTypes = {
	open: PropTypes.bool,
	onClose: PropTypes.func,
	transferMultipleLeadsArray: PropTypes.array,
}

PartnerTransferMultipleLeadModalPopup.defaultProps = {
	open: false,
	onClose: () => {},
}

export default PartnerTransferMultipleLeadModalPopup
